...
| git_upload.git_repo_with_access_token | string | `"https://GITHUB-TOKEN:x-oauth-basic@github.com/axiologic-pla/helm-charts.git"` | The repository url eg. https://GITHUB-TOKEN:x-oauth-basic@github.com/axiologic-pla/helm-charts.git |
