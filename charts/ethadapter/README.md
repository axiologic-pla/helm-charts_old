...
![Version: 0.7.15](https://img.shields.io/badge/Version-0.7.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.1.0](https://img.shields.io/badge/AppVersion-1.1.0-informational?style=flat-square)
...
2. Install via helm by passing sensitive *Org Account JSON* value in JSON format as escaped string
    ...
    ```bash
    helm upgrade --install ethadapter axiologic-pla/ethadapter --version=0.7.15 \
...
| image.repository | string | `"pharmaledger/ethadapter"` | The repository of the container image <!-- # pragma: allowlist secret --> |
