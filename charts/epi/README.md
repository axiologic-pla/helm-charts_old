...
![Version: 0.6.6](https://img.shields.io/badge/Version-0.6.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2023.1.1](https://img.shields.io/badge/AppVersion-2023.1.1-informational?style=flat-square)
...
2. Install via helm to namespace `default`
    ...
    ```bash
    helm upgrade my-release-name pharmaledgerassoc/epi --version=0.6.6 \
        --install \
...
| builder.image.sha | string | `"49fd4fa03499d0efdb70ca228ebae3ba9b65297d264dff059fb4b04305622f12"` | sha256 digest of the image for the builder. Do not add the prefix "@sha256:" Default to v1.3.1 <!-- # pragma: allowlist secret --> |
| builder.image.tag | string | `"2023.1.1"` | Image tag for the builder. Default to v1.3.1 |
...
| config.epiVersion | string | `"2023.1.1"` | The epi version |
...
| runner.image.sha | string | `"7927c151d4a4025682f8a94d94f313a3e87fc42bdd75514049c46688296a1aa7"` | sha256 digest of the image. Do not add the prefix "@sha256:" Default to v1.3.1 <!-- # pragma: allowlist secret --> |
| runner.image.tag | string | `"2023.1.1"` | Overrides the image tag whose default is the chart appVersion. Default to v1.3.1 |
